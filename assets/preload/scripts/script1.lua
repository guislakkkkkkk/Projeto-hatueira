...
function onCreate()
 if enabled == true then
  ...
  if thinlines == true then
    ...
    setObjectCamera('ANIMATORthing', 'other')
    ...
    addLuaText('COMPOSER')
        ...
        -- ANIMATOR --
    makeLuaText("ANIMATOR", animatorUser, 1000, 0, -1000)
    setObjectCamera('ANIMATOR', 'other')
    addLuaText('ANIMATOR')
    ...
    setTextColor('CHERthing', SecondaryColor2)
...
function onSongStart()
  if enabled == true then
    ...
    doTweenY('F', 'COMPOSER', 280, speedthing, ease)
	  doTweenY('G', 'ANIMATORthing', 445, speedthing, ease)
	  doTweenY('H', 'ANIMATOR', 410, speedthing, ease)
...
function onTimerCompleted(tag, loops, loopsLeft)
    if tag == 'ByeBye' then
        ...
        doTweenY('S', 'ANIMATORthing', -1300, speedthing, ease)
        doTweenY('T', 'ANIMATOR', -1300, speedthing, ease)
...
function onTweenCompleted(tag)
  if tag == 'X' then
    ...
    removeLuaText('ANIMATORthing', true)
    removeLuaText('ANIMATOR', true)
