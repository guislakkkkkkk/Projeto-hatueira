...
ComposerB = 'Fabi, ezzy, SpiritualOsu' -- PUT COMPOSER'S USER HERE
AnimatorC = 'Sonicrack_Tubbie, Saul' -- PUT ANIMATOR'S USER HERE
CharterD = 'KrashTheBot' -- PUT CHARTER'S USER HERE
